...
addon_id = 'plugin.video.pldplayerm3u'
selfAddon = xbmcaddon.Addon(id=addon_id)

#addon = Addon('plugin.video.pldplayerm3u', sys.argv)
#net = Net()
...
def playF4mLink(url,name='PLD-PLAYER[COLOR lime]M3U[/COLOR]',proxy=None,use_proxy_for_chunks=False,auth_string=None,streamtype='TSDOWNLOADER',setResolved=False,swf=""):
