...
def mainlist(item):
    logger.info("pelisalacarta.channels.hemerotecanba mainlist")
    itemlist = []
...
def novedades(item):
    logger.info("pelisalacarta.channels.hemerotecanba novedades")
    itemlist = []
...
def categorias(item):
    logger.info("pelisalacarta.channels.hemerotecanba categorias")
    itemlist = []
